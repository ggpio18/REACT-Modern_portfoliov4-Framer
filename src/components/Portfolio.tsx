...
const Portfolio = () => {
  return (
    <div className='text-white bg-gradient-to-b from-black to-[#381a5f] py-18 mt-40' id="porfolio">
...
=        </h1>
        ...
        <div className='max-w-[1000px] mx-auto mt-40 space-y-24'>
            {projects.map((project, index) => (
                ...
                className={`mt-12flex ${index % 2 === 1 ? "flex-col-reverse md:flex-row-reverse gap-12" : "flex-col md:flex-row"}`}
                >
                    
                    <div className='space-y-2 mx-w-[500px]'>
