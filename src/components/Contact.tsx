  ...
  return (
    ...
    space-y-8 lg:space-y-0 lg:space-x-8' id='contact'>
        ...
        <div className='flex justify-center items-center'>
            <ul className='space-y-4'>
                <li className='flex items-center'>
                    ...
                    <p className='text-xl'>+38912 1239</p>
                </li>
                <li className='flex items-center'>
                    <Image src={mail} alt='mail' className='h-[110px] w-auto mr-6'/>
                    <p className='text-xl'>somethiong@gamil.com</p>
                </li>
            </ul>
        </div>
        ...
        <div className='bg-white/10 p-6 rounded-xl max-w-[550px]'>
            ...
            <p className='text-white/70 mb-6'>Lorem ipsum dolor, sit amet consectetur adipisicing.</p>
            {/* connect to getForm.io */}
            <form className='space-y-4' action="getform" method='post'>
